...
<center><img src="\img\cooltext399147740170074.png" width="700" height="100"></center>
...
<div>
    ...
    <input class="form-control" type="text" name="titulo" id="" required maxlength="100">
</div>
<div>
    <label for=""><strong>Reseña:</strong></label>
    <textarea class="form-control" type="text" name="reseña" id="" cols="30" rows="10" required></textarea>
</div>
<div>
...
<div>
    ...
    <input class="form-control" type="text" name="director" id="" required maxlength="50">
</div>
<div>
    <label for=""><strong>Actores:</strong></label>
    <input class="form-control" type="text" name="actores" id="" required>
</div>
<div>
    <label for=""><strong>Año:</strong></label>
    <input class="form-control" type="text" name="año" id="" required maxlength="50">
</div>
<div>
    <label for=""><strong>URl del Trailer:</strong></label>
    <input class="form-control" type="text" name="url_video" id=""  placeholder="Ejemplo: https://www.youtube.com/embed/eOrNdBpGMv8" required >
</div>
<div>
    <label for=""><strong>Imagen:</strong></label>
    <input class="form-control" type="text" name="imagen" id=""  placeholder="Ejemplo: https://imagenesWeb/avengers-endgame.jpg" required >
</div>
<br>
<br>
